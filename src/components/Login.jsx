...
import { FiLock, FiMail, FiUser, FiTrendingUp } from "react-icons/fi";
            ...
            <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-slate-600 text-lg max-w-md mb-6">
                            Streamline your sales process and convert more leads with our powerful management system.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200 max-w-md">
                            <div className="flex items-start mb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-slate-800">Track & Manage Leads</h3>
                                    <p className="text-slate-600 text-sm">Organize your pipeline efficiently</p>
                                </div>
                            </div>
                            <div className="flex items-start mb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-slate-800">Increase Conversion</h3>
                                    <p className="text-slate-600 text-sm">Never miss a follow-up opportunity</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="font-semibold text-slate-800">Grow Your Business</h3>
                                    <p className="text-slate-600 text-sm">Turn prospects into customers faster</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500">Login to access your leads dashboard</p>
                    </div>
                    ...
                    <form onSubmit={submitHandler} className="space-y-6">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            disabled={loading}
                            className={`w-full py-3 px-4 rounded-lg font-medium text-white ${loading ? 'bg-indigo-400' : 'bg-indigo-600 hover:bg-indigo-700'} transition flex items-center justify-center shadow-md shadow-indigo-100 hover:shadow-indigo-200`}
                        >
                            {loading ? (
                                <>
